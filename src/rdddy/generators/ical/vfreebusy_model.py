...
class VFREEBUSYModel(BaseModel):
    ...
    organizer: str = Field(
        default=None, title="", description="The organizer of the VFREEBUSY period."
    )
    uid: str = Field(
        default=None,
        title="",
    ...
    url: str = Field(
        default=None, title="", description="The URL for the VFREEBUSY period."
    )
    dtstamp: datetime = Field(
        default=None,
        title="",
        description="The date and time when the VFREEBUSY was last modified.",
    )
    freebusy: str = Field(
        default=None,
        title="",
    ...
    attendee: str = Field(
        default=None, title="", description="The attendees for the VFREEBUSY period."
    )
    comment: str = Field(
        default=None,
        title="",
    ...
    request_status: str = Field(
        default=None, title="", description="The status of the VFREEBUSY request."
    )
    sequence: int = Field(
        default=None,
        title="",
